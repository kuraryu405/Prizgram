...
test("registers an active selection without a job posting and continues to its deadline", async ({
  page,
}) => {
  ...
  await page.getByLabel(/期限（Asia\/Tokyoの現地時刻）/).fill("2026-09-30T10:00");
